...
esp_err_t sd_spi_init(void)
{
    ...
    devcfg.clock_speed_hz = 20 * 1000 * 1000; /* SPI时钟 */
    devcfg.mode = 0;                          /* SPI模式0 */
    devcfg.spics_io_num = SD_NUM_CS;          /* 片选引脚 */
    devcfg.queue_size = 7;                    /* 事务队列尺寸 7个 */
    ...
    slot_config.host_id = (decltype(slot_config.host_id))host.slot;
